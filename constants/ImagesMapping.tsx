...
ufc: require('@/assets/images/channel_logos/ufc.png'),
wps: require('@/assets/images/channel_logos/wps.jpg'),
mmafighting: require('@/assets/images/channel_logos/mmafighting.png'),
liverpool: require('@/assets/images/channel_logos/liverpool.jpg'),
mercedesbenz: require('@/assets/images/new_channel_logos/mercedesbenz.jpg'),
rockstargames: require('@/assets/images/new_channel_logos/rockstargames.jpg'),
